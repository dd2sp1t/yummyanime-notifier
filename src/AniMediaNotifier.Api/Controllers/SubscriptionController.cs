using AniMediaNotifier.Api.Requests;
using AniMediaNotifier.Application.Subscriptions.Commands.SubscribeToAnime;
using AniMediaNotifier.Application.Subscriptions.Commands.UnsubscribeFromAnime;
using AniMediaNotifier.Application.Subscriptions.Queries.GetUserSubscriptions;
using MediatR;
using Microsoft.AspNetCore.Mvc;

namespace AniMediaNotifier.Api.Controllers;
