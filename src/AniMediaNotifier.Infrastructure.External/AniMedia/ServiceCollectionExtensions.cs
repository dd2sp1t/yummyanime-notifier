...
namespace AniMediaNotifier.Infrastructure.External.AniMedia;

internal static class ServiceCollectionExtensions
{
    public static IServiceCollection AddAniMediaTools(this IServiceCollection services, IConfiguration configuration)
    {
        return services
